...
for i=1:ks
    ...
    I1=I1.*F1+double(imnoise(uint8(I1),'poisson')-uint8(I1)) ;%对仿真图像加泊松噪声
    %     I1=I1.*F1;
    %     I1 = uint8((I1-min(min(I1)))/(max(max(I1))-min(min(I1)))*255) ;
    %     I1 = double(imnoise(I1,'gaussian',xutempw)) ; %对目标加高斯噪声
